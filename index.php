                  ...
                  <div class="row">
                     <div class="portfolio-items isotopeWrapper clearfix" id="3">
                       ...
                       ?>
                        ...
                        <article class="col-md-4 isotopeItem studia">
                           <div class="portfolio-item">
                              <div class="wow bounceIn">
                        ...
                        <article class="col-md-4 isotopeItem studia">
                           <div class="portfolio-item">
                              <div class="wow bounceIn">
                                 <img src="img/portfolio/21.jpg" alt="" />
                              </div>
                              <div class="portfolio-desc align-center">
                                 <div class="folio-info">
                                    <h5><a href="#">Project name 8</a></h5>
                                    <a href="img/portfolio/25.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
                                 </div>
                              </div>
                           </div>
                        </article>
                        <article class="col-md-4 isotopeItem portret">
                           <div class="portfolio-item">
                              <div class="wow rotateInDownRight">
                                 <img src="img/portfolio/30.jpg" alt="" />
                              </div>
                              <div class="portfolio-desc align-center">
                                 <div class="folio-info">
                                    <h5><a href="#">Project name 9</a></h5>
                                    <a href="img/portfolio/30.jpg" class="fancybox"><i class="fa fa-external-link fa-2x"></i></a>
                                 </div>
                              </div>
                           </div>
                        </article> -->
